        ...
        table.DataTable({
            ...
            columnDefs: [{
                ...
                /*   {
                       ...
                       orderable: false,
                       render: function(data, type, full, meta) {
                           return '\<a href="#" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Editar Usuario">\
                             <i class="la la-edit"></i>\
                           </a>\
                           \<a href="#" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Desactivar Usuario">\
